...
export default {
    ...
    homePage: {
        script1: {
            mainImage: project1,
            content: 'Giai đoạn Tiền lịch sử và sơ khai dựng nước',
            description: [
                {
                    content:
        ...
        script2: {
            mainImage: project2,
            content: 'Giai đoạn đấu tranh giữ nước',
            description: [
                {
                    content:
        ...
        script3: {
            mainImage: project3,
            content: 'Giai đoạn phong kiến xây dựng và bảo vệ tổ quốc',
            description: [
                {
                    content:
        ...
        script4: {
            mainImage: project4,
            content: 'Giai đoạn đấu tranh giải phóng dân tộc',
            description: [
                {
                    content:
        ...
        script5: {
            mainImage: project5,
            content: 'Giai đoạn thống nhất đất nước',
            description: [
                {
                    content:
        ...
        letters1: {
            imgs: [gd2, gd3],
            content: 'Những mái ấm không trọn vẹn',
            link: '/#noidau',
        },
        letters2: {
            imgs: [meChoCon],
            content: 'Những người mẹ mòn mỏi chờ con',
            link: '/#noidau',
        },
        letters3: {
            imgs: [ty],
            content: 'Những mối tình tuổi 18 chưa thành',
            link: '/#noidau',
        },
        letters4: {
            imgs: [tsdd],
            content: 'Giấc mơ đoàn tụ không thành',
            link: '/#noidau',
        },

        title: {
            content: 'Những dòng tâm sự còn dang dở',
            link: '/#noidau',
    ...
    chungtichPage: {
        ...
        projectsImages: [
            ...
            {
                itemIndex: 2,
                content: 'Hoàng thành Thăng Long',
                itemImage: pi2,
                itemDescription:
